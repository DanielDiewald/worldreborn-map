...
function Icon({ name }: { name: "home" | "map" | "timeline" | "person" | "god" | "character" | "group" | "location" | "link" | "tree" | "graph" | "media" | "players" | "shield" | "settings" | "world" }) {
...
function NavItem({ href, icon, children, active, disabled }: { href?: string; icon: Parameters<typeof Icon>[0]["name"]; children: ReactNode; active?: boolean; disabled?: boolean }) {
