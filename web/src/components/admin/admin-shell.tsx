...
type Section = "dashboard" | "npcs" | "races" | "gods" | "characters" | "groups" | "locations" | "relationships" | "family-trees" | "timeline" | "media" | "calendar" | "players" | "audit" | "projects" | "map" | "settings";
...
function ProjectNavigation({projectId,section,compact=false}:{projectId?:number;section:Section;compact?:boolean}){
  ...
  return <nav className={`admin-nav${compact?" mobile-admin-nav":""}`} aria-label={compact?"Mobile Admin Navigation":"Admin Navigation"}>
    ...
    <div className="nav-section"><span className="nav-section-title">World</span><NavItem href={projectId?`${base}/npcs`:undefined} icon="person" active={section==="npcs"} disabled={!projectId}>NPCs</NavItem><NavItem href={projectId?`${base}/races`:undefined} icon="world" active={section==="races"} disabled={!projectId}>Spezies</NavItem><NavItem href={projectId?`${base}/gods`:undefined} icon="god" active={section==="gods"} disabled={!projectId}>Götter</NavItem><NavItem href={projectId?`${base}/characters`:undefined} icon="character" active={section==="characters"} disabled={!projectId}>Spielercharaktere</NavItem><NavItem href={projectId?`${base}/groups`:undefined} icon="group" active={section==="groups"} disabled={!projectId}>Gruppen</NavItem><NavItem href={projectId?`${base}/locations`:undefined} icon="location" active={section==="locations"} disabled={!projectId}>Orte</NavItem><NavItem href={projectId?`${base}/relationships`:undefined} icon="link" active={section==="relationships"} disabled={!projectId}>Beziehungen</NavItem></div>
