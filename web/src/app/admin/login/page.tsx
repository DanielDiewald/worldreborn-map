    ...
    <main className="login-wrap">
      <section className="login-card stack">
        <div className="login-brand">
          ...
          <div><strong>WorldReborn</strong><span>Private World Archive</span></div>
        </div>
        <div>
        ...
        {error ? <p className="error">{errorMessages[error] ?? "Anmeldung fehlgeschlagen."}</p> : null}
        <form action={loginAdmin} className="stack">
          ...
          <button className="primary" type="submit">Admin-Bereich öffnen</button>
        </form>
      </section>
    </main>
  );
